...
export async function POST() {
	try {
		console.log('🔧 Initializing creator profiles in Redis...')
		...
		console.log('✅ Creator profiles initialization completed')
		...
		console.error('❌ Profiles initialization error:', error)
		return NextResponse.json<ApiResponse<null>>({
			success: false,
			error: 'Failed to initialize creator profiles'
		}, { status: 500 })
	}
}
